...
// eAthena additions
	...
	int bg_items_on_pvp;
	int bg_reward_rates;
	int bg_badges; 			//[RagnaDev]
	int bg_battle_badges; 	//[RagnaDev]
	int bg_kafrapoints; 	//[RagnaDev]
	int bg_event_extra_badges; //[RagnaDev]
	int bg_win_badges; 		//[RagnaDev]
	...
	int min_guild; // [RagnaDev]
	int use_aegis_land_shower; //[RagnaDev] arrow shower fix]
	int oboro_enable; // [RagnaDev]
