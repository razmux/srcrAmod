...
//		unsigned int autolooting : 1; //performance-saver, autolooting state for @alootid
		...
		unsigned int spb : 1; // @spb / @partybuff [RagnaDev]
		unsigned int restock : 1; // [RagnaDev]
		unsigned int afk : 1; // [RagnaDev]
		unsigned int oboro_showinfo : 1; // [RagnaDev]
		unsigned int hold : 1; // [RagnaDev]
